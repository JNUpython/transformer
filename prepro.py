...
def prepro(hp):
    ...
    logging.info(len(prepro_train1))
    # logging.info(prepro_train1[:3])
    # logging.info(prepro_train2[:3])
    # eval
    ...
    logging.info(len(prepro_eval1))
    # logging.info(prepro_eval1[:3])
    # logging.info(prepro_eval2[:3])
